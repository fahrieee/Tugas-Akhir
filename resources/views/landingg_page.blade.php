...
<head>
    ...
    <!--====== Favicon Icon ======-->
    <link rel="shortcut icon" href="{{ asset('arch') }}/assets/images/favicon.png" type="image/png">
        
        
    <!--====== Animate CSS ======-->
    <link rel="stylesheet" href="{{ asset('arch') }}/assets/css/animate.css">
        
    <!--====== Line Icons CSS ======-->
    <link rel="stylesheet" href="{{ asset('arch') }}/assets/css/LineIcons.css">
        
    <!--====== Bootstrap CSS ======-->
    <link rel="stylesheet" href="{{ asset('arch') }}/assets/css/bootstrap.min.css">
    
    <!--====== Default CSS ======-->
    <link rel="stylesheet" href="{{ asset('arch') }}/assets/css/default.css">
    
    <!--====== Style CSS ======-->
    <link rel="stylesheet" href="{{ asset('arch') }}/assets/css/style.css">
    
</head>

<body>
    <!--[if IE]>
    <p class="browserupgrade">You are using an <strong>outdated</strong> browser. Please <a href="{{ asset('arch') }}/https://browsehappy.com/">upgrade your browser</a> to improve your experience and security.</p>
  <![endif]-->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg">
                            <a class="navbar-brand" href="{{ asset('arch') }}/index.html">
                                <img src="{{ asset('arch') }}/images/logo.png" alt="Logo">
                            </a>
                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                                <ul id="nav" class="navbar-nav ml-auto">
                                    <li class="nav-item active">
                                        <a class="page-scroll" href="{{ asset('arch') }}/#home">Home</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="page-scroll" href="{{ asset('arch') }}/#about">About</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="page-scroll" href="{{ asset('arch') }}/#services">Services</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="page-scroll" href="{{ asset('arch') }}/#gallery">Gallery</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="page-scroll" href="{{ asset('arch') }}/#team">Team</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="page-scroll" href="{{ asset('arch') }}/#testimonial">Clients</a>
                                    </li>                                    
                                    <li class="nav-item">
                                        <a class="page-scroll" href="{{ asset('arch') }}/#contact">Contact</a>
                                    </li>
                                </ul>
                            </div> <!-- navbar collapse -->
                        </nav> <!-- navbar -->
                    ...
                    <div class="row">
                        <div class="col-lg-10 col-md-10">
                            <div class="slider_content">
                                ...
                                <a href="{{ asset('arch') }}/https://rebrand.ly/arch-ui" rel="nofollow" class="main-btn wow fadeInLeftBig" data-wow-duration="1.3s" data-wow-delay="0.8s">Purchase Now</a>
                            </div> <!-- slider content -->
                        </div>
                    </div> <!-- row -->
                </div> <!-- container -->
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="single_features text-center mt-30 wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.2s">
                        <div class="features_image">
                            <img src="{{ asset('arch') }}/images/features-1.jpg" alt="features">
                        </div>
                        <div class="features_content">
                            <h4 class="features_title"><a href="{{ asset('arch') }}/#">Project Planing</a></h4>
                        </div>
                    </div> <!-- single features -->
                </div>
                <div class="col-lg-4 col-md-4">
                    <div class="single_features text-center mt-30 wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.5s">
                        <div class="features_image">
                            <img src="{{ asset('arch') }}/images/features-2.jpg" alt="features">
                        </div>
                        <div class="features_content">
                            <h4 class="features_title"><a href="{{ asset('arch') }}/#">Architecture</a></h4>
                        </div>
                    </div> <!-- single features -->
                </div>
                <div class="col-lg-4 col-md-4">
                    <div class="single_features text-center mt-30 wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.8s">
                        <div class="features_image">
                            <img src="{{ asset('arch') }}/images/features-3.jpg" alt="features">
                        </div>
                        <div class="features_content">
                            <h4 class="features_title"><a href="{{ asset('arch') }}/#">Construction</a></h4>
                        </div>
                    </div> <!-- single features -->
                </div>
            </div> <!-- row -->
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="about_image mt-50 wow fadeInRightBig" data-wow-duration="1.3s" data-wow-delay="0.5s">
                        <img src="{{ asset('arch') }}/images/about_image.jpg" alt="About">
                    </div> <!-- about image -->
                </div>
                <div class="col-lg-6">
                    <div class="about_content mt-50 wow fadeInLeftBig" data-wow-duration="1.3s" data-wow-delay="0.5s">
                        ...
                        <a href="{{ asset('arch') }}/#" class="main-btn">Read More</a>
                    </div> <!-- about content -->
                </div>
            </div> <!-- row -->
        </div> <!-- container -->
    ...
    <section class="footer_area bg_cover" style="background-image: url(assets/images/footer_bg.jpg)">
        <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="footer_about mt-50">
                            <a href="{{ asset('arch') }}/#"><img src="{{ asset('arch') }}/images/logo.png" alt="logo"></a>
                    ...
                    <div class="col-lg-8">
                        <div class="footer_link_wrapper d-flex flex-wrap">
                            <div class="footer_link mt-45">
                                ...
                                <ul class="link">
                                    <li><a href="{{ asset('arch') }}/#">Home</a></li>
                                    <li><a href="{{ asset('arch') }}/#">About</a></li>
                                    <li><a href="{{ asset('arch') }}/#">Service</a></li>
                                    <li><a href="{{ asset('arch') }}/#">Gallery</a></li>
                                    <li><a href="{{ asset('arch') }}/#">Blog</a></li>
                                </ul>
                            </div> <!-- footer link -->
                            <div class="footer_link mt-45">
                                <h4 class="footer_title">Support</h4>
                                <ul class="link">
                                    <li><a href="{{ asset('arch') }}/#">Terms & Condition</a></li>
                                    <li><a href="{{ asset('arch') }}/#">Privacy</a></li>
                                    <li><a href="{{ asset('arch') }}/#">Policy</a></li>
                                    <li><a href="{{ asset('arch') }}/#">Leal</a></li>
                                    <li><a href="{{ asset('arch') }}/#">Leal</a></li>
                                </ul>
                            </div> <!-- footer link -->
                            <div class="footer_link mt-45">
                                ...
                                <ul class="link">
                                    <li><a href="{{ asset('arch') }}/#">Facebook</a></li>
                                    <li><a href="{{ asset('arch') }}/#">Twitter</a></li>
                                    <li><a href="{{ asset('arch') }}/#">Instageam</a></li>
                                    <li><a href="{{ asset('arch') }}/#">Linkdin</a></li>
                                    <li><a href="{{ asset('arch') }}/#">Pintarest</a></li>
                                </ul>
                            </div> <!-- footer link -->
            ...
            <div class="footer_copyright text-center">
                <p>Designed and Developed by <a href="{{ asset('arch') }}/https://uideck.com" rel="nofollo">UIdeck</a></p>
            </div>
        </div> <!-- container -->
    </section>
    ...
    <a href="{{ asset('arch') }}/#" class="back-to-top"><i class="lni lni-chevron-up"></i></a>

    <!--====== BACK TOP TOP PART ENDS ======-->


    <!--====== Jquery js ======-->
    <script src="{{ asset('arch') }}/js/vendor/jquery-1.12.4.min.js"></script>
    <script src="{{ asset('arch') }}/js/vendor/modernizr-3.7.1.min.js"></script>
    
    <!--====== Bootstrap js ======-->
    <script src="{{ asset('arch') }}/js/popper.min.js"></script>
    <script src="{{ asset('arch') }}/js/bootstrap.min.js"></script>

    
    <!--====== Scrolling Nav js ======-->
    <script src="{{ asset('arch') }}/js/jquery.easing.min.js"></script>
    <script src="{{ asset('arch') }}/js/scrolling-nav.js"></script>
    
    <!--====== WOW js ======-->
    <script src="{{ asset('arch') }}/js/wow.min.js"></script>


    
    <!--====== Main js ======-->
    <script src="{{ asset('arch') }}/js/main.js"></script>

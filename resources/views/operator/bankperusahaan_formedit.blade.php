            ...
            <div class="card"> 
                ...
                <div class="card-body">
                    ...
                    <div class="form-group mt-1">
                        <label for="bank_id">Nama Rekening</label>
                        {!! Form::select('bank_id', $listBank, null, ['class' => 'form-control select2', 'disabled' => 'disabled']) !!}
                        <span class="text-danger">{{ $errors->first('bank_id') }}</span>
                    </div>
                    
                    <!-- Nomor Rekening (Disabled) -->
                    <div class="form-group mt-3">
                        <label for="nomor_rekening">Nomor Rekening</label>
                        {!! Form::text('nomor_rekening', null, ['class' => 'form-control', 'disabled' => 'disabled']) !!}

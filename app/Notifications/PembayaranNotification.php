...
class PembayaranNotification extends Notification
{
    ...
    public function toArray($notifiable)
    {
        return [
            ...
            'pengawas_id' => $this->pembayaran->pengawas_id,
            'pembayaran_id' => $this->pembayaran->id,
            'title' => 'Pembayaran Tagihan',
            'messages' => $this->pembayaran->pengawas->name . ' Melakukan Pembayaran Tagihan.' ,
    ...
    public function toWhacenter($notifiable)
    {
        ...
        return (new WhacenterService())
            ->to($notifiable->nohp)
            ->line("Hallo Operator,")
            ->line("Ada Pembayaran Tagihan")
            ->line($this->pembayaran->pengawas->name . ' Melakukan pembayaran tagihan.')
